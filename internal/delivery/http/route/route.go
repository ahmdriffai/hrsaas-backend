...
func (c *RouteConfig) SetupAttendanceRouter() {
	...
	// route.Post("/:employee_id/face", adminMW, c.AttendanceController.RegisterFace)
	// route.Get("/:employee_id/face", adminMW, c.AttendanceController.FaceStatus)
	route.Delete("/:employee_id/face", adminMW, c.AttendanceController.DeleteFace)
